...
let addresses = [
	...
	'skk.moe-2053#优选域名',
    'icook.hk-8443#优选域名',
    'cf.090227.xyz-2087#CM提供',
    'cfip.xxxxxxxx.tk-8443#OTC提供',
];

// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/djd1226/yxip/main/yxip6.txt' //可参考内容格式 自行搭建。
];
...
let subconverter = "change.djd781226.workers.dev"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
